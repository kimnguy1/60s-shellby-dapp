...
import { syntheticCreators, syntheticFollowGraphHints } from "../../api/src/db/syntheticFixtures";
...
export default function HomePage() {
  ...
  const connectWithAddress = async (rawAddress: string) => {
    ...
    await connectWallet(normalized, displayName || undefined);
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Failed to read saved profile settings");
    }
    ...
    <main className="app-shell">
      <header className="main-header">
        ...
        <div className="header-actions">
          ...
          <button className="profile-trigger" onClick={() => setNavPanel(profile ? "profile" : "wallet")} aria-label="Profile">
                ...
                <div className="panel profile-sheet">
                  {profile ? (
                    ...
                    <>
                      ...
                      <small>Connect wallet to load profile.</small>
                    </>
                  )}
                </div>
              ) : null}
